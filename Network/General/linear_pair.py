...
class LinearKeyPairNetwork(Network):
    ...
    def __init__(self, args):
        ...
        decode_layer_args.num_inputs = self.embed_dim * self.total_instances
        ...
        reconstruct_layer_args.output_dim = self.object_dim # must have embed_inputs
        ...
        layers = [self.embed_key_layer, self.embed_query_layer, self.pair_network, self.reconstruction, self.decode_layer]
    ...
    def forward(self, x, m=None, return_embeddings=False, return_reconstruction=False):
