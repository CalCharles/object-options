...
from Causal.FullInteraction.full_interaction_model import NeuralFullInteractionForwardModel
...
if __name__ == '__main__':
    ...
    full_model = FullNeuralInteractionForwardModel(args, environment)
    args.target_select, args.inter_select = full_model.extractor.get_selectors()
