...
full_args = {
    ...
    "multi_inter": {
        "evaluate": 1, # evaluation mode, where a trained model is tested for how well it can predict actual cause using null assumption, if 0, no evaluation, if 1, only evaluation, if 2, both train and eval
